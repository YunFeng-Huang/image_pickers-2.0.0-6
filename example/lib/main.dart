            ...
            child: Column(
              children: <Widget>[
                GridView.builder(
                    ...
                    shrinkWrap: true,
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3, mainAxisSpacing: 20.0, crossAxisSpacing: 10.0, childAspectRatio: 1.0),
...
//                        ImagePickers.previewImages(paths,index);
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    dataImagePath = await ImagePickers.saveByteDataImageToGallery(
                      data,
                    );
